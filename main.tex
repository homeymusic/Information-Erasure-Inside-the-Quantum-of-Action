...
Quantized phase-space from information erasure

$\phi_{\epsilon=0.01}=\mathtt{110101010}$
$\phi_{\epsilon=0.001}=\mathtt{110101010}$
$\operatorname{erase}$

\begin{equation}
\delta_x \Delta p < \frac{h}{2}, \quad \Delta x \delta_p < \frac{h}{2}
\end{equation}
