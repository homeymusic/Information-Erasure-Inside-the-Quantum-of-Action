...
Total system entropy $\mathcal{S} = \mathrm{H} + \mathrm{K}$ scales with the system's action $A$ normalized by the quantum of action $A_0 = \frac{\pi}{4} q_0 p_0 = \frac{h}{2}$. Here, $\mathrm{H}$ and $\mathrm{K}$ represent Shannon entropy and Kolmogorov complexity, respectively. 
