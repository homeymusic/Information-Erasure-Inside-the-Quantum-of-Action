...
\begin{abstract}
By maximizing entropy through Landauer information erasure within de Gosson's quantum of action, we show that continuum states collapse into discrete conjugate observables. Numerical results confirm that these constraints reflect the experimental distributions of quantum phenomena, revealing underlying microstate distributions where Schrödinger-eigenstates appear as accessible configurations rather than privileged solutions. At the entropic limit of action, this work provides a thermodynamic-geometric correspondence to standard quantum mechanics.
\end{abstract}
